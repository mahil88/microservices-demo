...
@Component
@ConditionalOnExpression("${twitter-to-kafka-service.enable-mock-tweets} && not ${twitter-to-kafka-service.enable-tweets} && not ${twitter-to-kafka-service.enable-v2-tweets}")
